...
task :makehtml do
	...
	puts `maketzjs --mode canvas -t templates -t . -o gameoflife.tzjs gameoflife.js`
	puts `makehtml --mode canvas -t templates -t . -o gameoflife.plugin.debug.html gameoflife.html gameoflife.js`
end
